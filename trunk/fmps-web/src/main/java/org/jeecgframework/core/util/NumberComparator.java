...
public class NumberComparator implements Comparator<Object> {
	...
	public NumberComparator(boolean ignoreCase, boolean flag) {
		this.ignoreCase = ignoreCase;
		this.flag = flag;
	}
	...
	public int compare(Object obj1, Object obj2) {
		...
		if (flag) {
			WeixinClaimCommonWords c1 = (WeixinClaimCommonWords) obj1;
			WeixinClaimCommonWords c2 = (WeixinClaimCommonWords) obj2;
			o1 = c1.getHsOrder();
			o2 = c2.getHsOrder();
		}
		if (o1 != null && o2 != null) {
