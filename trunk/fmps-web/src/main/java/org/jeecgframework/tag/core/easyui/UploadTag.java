...
public class UploadTag extends TagSupport {
	...
	private static final Logger logger = Logger.getLogger(UploadTag.class);
...
//		String webRootUrl = WebApplicationUtils.getWebRootUrl(this.pageContext.getRequest());
		ResourceBundle bundler = ResourceUtil.getBundleEnvAbout();
		String webRootUrl = bundler.getString("domain");
		logger.info("上传标签upload webRootUrl(domain获取):" + webRootUrl);
		...
		sb.append("<link rel=\"stylesheet\" href=\"" + webRootUrl + "/plug-in/uploadify/css/uploadify.css\" type=\"text/css\"></link>");
		sb.append("<script type=\"text/javascript\" src=\"" + webRootUrl + "/plug-in/uploadify/jquery.uploadify-3.1.js\"></script>");
		sb.append("<script type=\"text/javascript\" src=\"" + webRootUrl + "/plug-in/tools/Map.js\"></script>");
		sb.append("<script type=\"text/javascript\">"
				...
				+"fileTypeExts:\'"+extend+"\',"
				+"fileSizeLimit:\'15MB\',"
				+"swf:\'" + webRootUrl + "/plug-in/uploadify/uploadify.swf\',	"
		       ...
		       sb.append("} ," 	          
				...
				if(view)
				{
				sb.append("var fileitem=\"<span id=\'\"+d.attributes.id+\"\'><a href=\'#\' onclick=openwindow(\'文件查看\',\'\"+d.attributes.viewhref+\"\',\'70%\',\'80%\') title=\'查看\'>\"+d.attributes.name+\"</a><img border=\'0\' onclick=confuploadify(\'\"+d.attributes.delurl+\"\',\'\"+d.attributes.id+\"\') title=\'删除\' src=\'" + webRootUrl + "/plug-in/uploadify/img/uploadify-cancel.png\' widht=\'15\' height=\'15\'>&nbsp;&nbsp;</span>\";");
