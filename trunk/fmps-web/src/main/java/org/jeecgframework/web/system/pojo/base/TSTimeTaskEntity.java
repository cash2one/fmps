...
public class TSTimeTaskEntity implements java.io.Serializable {
	...
	/**任务IP地址过滤*/
	private java.lang.String ipFilter;
	...
	@Column(name ="IP_Filter",nullable=true,length=50)
	public java.lang.String getIpFilter() {
		return ipFilter;
	}
	public void setIpFilter(java.lang.String ipFilter) {
