...
/*	@Autowired
	...
	@ResponseBody
	public void datagrid(ReceiveMessage receiveText,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
	...
	@ResponseBody
	public AjaxJson deleteSmsGroup(ReceiveMessage receiveText,HttpServletRequest req){
		AjaxJson j = new AjaxJson();
		receiveText = this.systemService.getEntity(ReceiveMessage.class, receiveText.getId());
	...
	@ResponseBody
	public AjaxJson updateAndSave(ReceiveMessage receiveText,HttpServletRequest req){
		AjaxJson j = new AjaxJson();
		ReceiveMessage  tempTextMessage= this.systemService.getEntity(ReceiveMessage.class, receiveText.getId());
		this.message =  "回复信息成功！";
		try {
