...
@Transactional
public class ReceiveMessageServiceImpl extends CommonServiceImpl implements
	...
	public <T> void delete(T entity) {
		super.delete(entity);
		// 执行删除操作配置的sql增强
		this.doDelSql((ReceiveMessage) entity);
	}
	...
	public <T> Serializable save(T entity) {
		...
		// 执行新增操作配置的sql增强
		this.doAddSql((ReceiveMessage) entity);
		return t;
	}
	...
	public <T> void saveOrUpdate(T entity) {
		...
		// 执行更新操作配置的sql增强
		this.doUpdateSql((ReceiveMessage) entity);
	}
	 ...
	 */
	@Override
	public boolean doAddSql(ReceiveMessage t) {
		return true;
	}
	 ...
	 */
	@Override
	public boolean doUpdateSql(ReceiveMessage t) {
		return true;
	}
	 ...
	 */
	@Override
	public boolean doDelSql(ReceiveMessage t) {
		return true;
	}

	@Override
	public String getFilePath(String mediaid) {
		ReceiveMessage receiveMessage = this.findUniqueByProperty(
				ReceiveMessage.class, "mediaId", mediaid);
		return receiveMessage.getPath();
	}
	/**
	 * 替换sql中的变量
	 * 
