...
<head>
	...
	<link rel="stylesheet" href="${webRoot}/plug-in/carHome/css/4S.css" />
...
<body>
	...
	<div data-am-widget="slider" class="am-slider am-slider-a1 am-no-layout" style="clear:both;">
		<ul class="am-slides">
			<li style="border-bottom: 1px solid #e8e8e8;"><a href="#"
				class="#"><img src="${webRoot}/plug-in/carHome/images/banner_car_top_3.jpg" /></a></li>
		</ul>
	</div>
	...
	function loadmerchantList(){
		...
		$.ajax({
			url : "${webRoot}/fo/carHomeController.do?method=get4sFactoryList",
			data : {
				"openid":'${openid}',
				"citycode":citycode,
