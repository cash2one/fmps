			...
			<div  class="am-cf admin-main">
				<div  	class="admin-content">
					 ...
					 <div style="width:94%; margin:0 auto; border-bottom:1px 0 0 0 solid #ddd; height:auto; margin-bottom:10px; font-size:1em; padding:5px 0px 5px 5px;">       
				        ...
				        <br/>证件号码：${customerPolicys.identifynumber}
						...
						<br/>保费：<fmt:formatNumber	value="${customerPolicys.sumPremium}" pattern="#,##0.00#" />
					</div>
				        ...
				        <form class="am-form">
				          ...
				          <tbody>
				          	<c:forEach items="${customerPolicys.customerPolicyDetailList}" var="customerPolicyDetails">
					            <tr>
					              <td colspan="2" style="width:35%;  text-align:center; font-size:14px;">${customerPolicyDetails.kindname }</td>
					              <td style="width:35%;  text-align:center;">${customerPolicyDetails.itemdetailname }</td>
