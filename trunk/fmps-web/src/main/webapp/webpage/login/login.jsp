...
<body>
            ...
            <div class="formLogin">
                <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
                    ...
                    <div class="tip">
                        ...
                        <input class="password" name="password" type="password" id="password" title="密码" value="" nullmsg="请输入密码!" autocomplete="off" disableautocomplete/>
                    </div>
                    <div class="tip">
                        <input class="randCode" name="randCode" type="text" id="randCode" title="" value="" nullmsg="请输入验证码!" />
                        <div style="float: right; margin-left:-220px; margin-right: 30px;">
                            <img id="randCodeImage" src="${webRoot}/randCode.do?genCode" />
                        </div>
                    </div>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; 版权所有 <span class="tip"><a href="http://www.fubon.com.cn" title="富邦财产保险有限公司">富邦财产保险有限公司</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)</span></div>
    </div>
    <!-- Link JScript-->
