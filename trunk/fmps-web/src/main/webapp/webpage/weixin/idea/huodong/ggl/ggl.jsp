...
<input class="pxbtn" id="save-btn" name="提 交" type="button" value="提 交">
	...
	<ul> 
		<li>一等奖：${huodongEntity.prizeone}，数量：${huodongEntity.onetotal}</li>
		<li>二等奖：${huodongEntity.prizetwo}，数量：${huodongEntity.twototal}</li>
		<li>三等奖：${huodongEntity.prizethree}，数量：${huodongEntity.threetotal}</li>
	</ul>
	</div>
	<div class="int">
