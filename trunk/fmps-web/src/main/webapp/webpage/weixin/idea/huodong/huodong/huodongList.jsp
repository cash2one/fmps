...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="huodongList${type}" title="活动" actionUrl="huodongController.do?datagrid&type=${type}" idField="id" fit="true">
   ...
   <t:dgCol title="一等奖奖品" field="prizeone" width="60" ></t:dgCol>
   <t:dgCol title="二等奖奖品" field="prizetwo" width="60"></t:dgCol>
   <t:dgCol title="三等奖奖品" field="prizethree" width="60"></t:dgCol>
