  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="huodongController.do?save">
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="prizeone" name="prizeone" ignore="ignore"
							   value="${huodongPage.prizeone}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="prizetwo" name="prizetwo" ignore="ignore"
							   value="${huodongPage.prizetwo}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="prizethree" name="prizethree" ignore="ignore"
							   value="${huodongPage.prizethree}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<select id="type" name="type" ignore="ignore">
						<option value="1"  <c:if test="${huodongPage.type == '1'}">selected</c:if> >刮刮乐</option>
						<option value="2"  <c:if test="${huodongPage.type == '2'}">selected</c:if>>大转盘</option>
					</select>
						<span class="Validform_checktip"></span>
					</td>
				</tr>
