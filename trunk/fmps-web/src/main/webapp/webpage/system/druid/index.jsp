...
<html>
	<head>
		<title class="lang" langKey="xxxx">Druid Stat Index2015</title>
		<meta http-equiv="Content-Type" content="text/html; charset=utf8" />
		<link href="/plug-in/druid/css/bootstrap.min.css" rel="stylesheet" />
		<link href="/plug-in/druid/css/style.css" type="text/css" rel="stylesheet"/>
    	<script type="text/javascript" src="/plug-in/druid/js/jquery.min.js"></script>
    	<script src="/plug-in/druid/js/lang.js" type="text/javascript" charset="utf8"></script>
		<script src="/plug-in/druid/js/common.js" type="text/javascript" charset="utf8"></script>
	</head>
	<body>
