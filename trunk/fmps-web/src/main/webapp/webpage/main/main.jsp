...
<!-- 顶部-->
<div region="north" border="false" title="富邦财产保险有限公司" style="BACKGROUND: #E6E6FA; height: 85px; padding: 1px; overflow: hidden;">
...
<c:if test="${map=='1'}">
	<div class="easyui-tab" title="地图" style="padding: 1px; overflow: hidden;"><iframe name="myMap" id="myMap" scrolling="no" frameborder="0" src="mapController.do?map&username=${userName}"
...
<div align="center" style="color: #CC99FF; padding-top: 2px">&copy; 版权所有 <span class="tip"><a href="http://www.fubon.com.cn" title="富邦财产保险有限公司">富邦财产保险有限公司</a> (推荐谷歌浏览器，获得更快响应速度)</span></div>
</div>
